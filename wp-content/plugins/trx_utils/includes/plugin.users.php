...
if (!function_exists('trx_utils_add_login_link')) {
	add_action('trx_utils_action_login', 'trx_utils_add_login_link', 10, 3);
	function trx_utils_add_login_link($link_text='', $link_title='', $show_attr=array()) {
		static $inc_id = 0;
		$inc_id ++;
		if (empty($show_attr)) {
			$show_attr=array('link', 'popup');
		}
...
if (!function_exists('trx_utils_add_register_link')) {
	add_action('trx_utils_action_register', 'trx_utils_add_register_link', 10, 3);
	function trx_utils_add_register_link($link_text='', $link_title='', $show_attr=array()) {
		static $inc_id = 0;
		$inc_id ++;
		if (empty($show_attr)) {
			$show_attr=array('link', 'popup');
