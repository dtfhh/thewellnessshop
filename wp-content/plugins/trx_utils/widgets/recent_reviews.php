 ...
 */
add_action( 'widgets_init', 'organics_widget_recent_reviews_load' );

/**
 * Register our widget.
 */
function organics_widget_recent_reviews_load() {
	register_widget('organics_widget_recent_reviews');
}

/**
 * recent_reviews Widget class.
 */
class organics_widget_recent_reviews extends WP_Widget {
	...
	function __construct() {
		...
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'organics_widget_recent_reviews');

		/* Create the widget. */
		parent::__construct( 'organics_widget_recent_reviews', esc_html__('Organics - Recent reviews', 'trx_utils'), $widget_ops, $control_ops );
	...
	function widget($args, $instance) {
		...
		$post_rating = 'reviews_avg'.(organics_get_theme_option('reviews_first')=='author' ? '' : '2');
