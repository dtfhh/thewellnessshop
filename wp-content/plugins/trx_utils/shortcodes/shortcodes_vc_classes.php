...
// Shortcode template
if ( ! class_exists( 'ORGANICS_VC_ShortCode' ) ) {
	abstract class ORGANICS_VC_ShortCode extends WPBakeryShortCode {
...
if ( ! class_exists( 'ORGANICS_VC_ShortCodeSingle' ) ) {
	abstract class ORGANICS_VC_ShortCodeSingle extends ORGANICS_VC_ShortCode {
	}
}

// Single shortcode without params (woocommerce_cart, checkout, etc.)
if ( ! class_exists( 'ORGANICS_VC_ShortCodeAlone' ) ) {
	abstract class ORGANICS_VC_ShortCodeAlone extends ORGANICS_VC_ShortCode {
		protected $controls_list = array('clone', 'delete');
	}
}

// Container shortcode (block, section, parallax)
if ( ! class_exists( 'ORGANICS_VC_ShortCodeContainer' ) ) {
	abstract class ORGANICS_VC_ShortCodeContainer extends ORGANICS_VC_ShortCode {
...
if ( ! class_exists( 'ORGANICS_VC_ShortCodeCollection' ) ) {
	abstract class ORGANICS_VC_ShortCodeCollection extends ORGANICS_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( ! class_exists( 'ORGANICS_VC_ShortCodeItem' ) ) {
	abstract class ORGANICS_VC_ShortCodeItem extends ORGANICS_VC_ShortCode {
...
if ( ! class_exists( 'ORGANICS_VC_ShortCodeColumns' ) ) {
	abstract class ORGANICS_VC_ShortCodeColumns extends ORGANICS_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( ! class_exists( 'ORGANICS_VC_ShortCodeAccordion' ) ) {
	abstract class ORGANICS_VC_ShortCodeAccordion extends WPBakeryShortCode_VC_Accordion {}
	abstract class ORGANICS_VC_ShortCodeAccordionItem extends WPBakeryShortCode_VC_Accordion_tab {}
}
if ( ! class_exists( 'ORGANICS_VC_ShortCodeToggles' ) ) {
	abstract class ORGANICS_VC_ShortCodeToggles extends ORGANICS_VC_ShortCodeAccordion {}
	abstract class ORGANICS_VC_ShortCodeTogglesItem extends ORGANICS_VC_ShortCodeAccordionItem {}
}
...
if ( ! class_exists( 'ORGANICS_VC_ShortCodeTabs' ) ) {
	abstract class ORGANICS_VC_ShortCodeTabs extends WPBakeryShortCode_VC_Tabs {
		public function setCustomTabId( $content ) {
			return preg_replace( '/tab\_id\=\"([^\"]+)\"/', 'tab_id="sc_tab_$1_' . time() . '"', $content );
		}
	}
	abstract class ORGANICS_VC_ShortCodeTab extends WPBakeryShortCode_VC_Tab {
	}
}
