				...
				$comments_args = array(
						...
						'fields' => apply_filters( 'comment_form_default_fields', array(
							'author' => '<div class="columns_wrap"><div class="comments_field comments_author column-1_1">'
									...
									. '<input id="author" name="author" type="text" placeholder="' . esc_html__( 'Name', 'organics' ) . ( $req ? ' *' : '') . '" value="' . esc_attr( isset($commenter['comment_author']) ? $commenter['comment_author'] : '' ) . '" size="30"' . ($aria_req) . ' />'
									. '</div>',
							'email' => '<div class="comments_field comments_email column-1_1">'
									...
									. '<input id="email" name="email" type="text" placeholder="' . esc_html__( 'Email', 'organics' ) . ( $req ? ' *' : '') . '" value="' . esc_attr(  isset($commenter['comment_author_email']) ? $commenter['comment_author_email'] : '' ) . '" size="30"' . ($aria_req) . ' />'
									. '</div>',
							'url' => '<div class="comments_field comments_site column-1_1">'
									. '<label for="url" class="optional">' . esc_html__( 'Website', 'organics' ) . '</label>'
									. '<input id="url" name="url" type="text" placeholder="' . esc_html__( 'Website ololol', 'organics' ) . '" value="' . esc_attr(  isset($commenter['comment_author_url']) ? $commenter['comment_author_url'] : '' ) . '" size="30"' . ($aria_req) . ' />'
									. '</div>'
									. '</div>'
						) ),
                    ...
                    'comment_field' => '<div class="columns_wrap"><div class="comments_field comments_message column-1_1">'
                        ...
                        . '<textarea id="comment" name="comment" placeholder="' . esc_html__( 'Comment', 'organics' ) . '" aria-required="true"></textarea>'
                        . '</div>'.'</div>'
				);
