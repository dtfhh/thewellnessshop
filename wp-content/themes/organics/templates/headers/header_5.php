                ...
                <div class="main-menu_wrapper">
                    <div class="content_wrap">
                        <div class="menu_main_wrap clearfix">
                            ...
                            <?php
                            if (organics_get_custom_option('show_search')=='yes' && function_exists('organics_sc_search'))
                                organics_show_layout(organics_sc_search(array('class'=>"top_panel_icon", 'state'=>"closed")));
                            ?>
                            <?php
