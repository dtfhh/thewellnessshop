...
if ( !function_exists( 'organics_options_load_scripts' ) ) {
	function organics_options_load_scripts() {
		...
		global $ORGANICS_GLOBALS;
			...
			wp_enqueue_script('organics-colors-script',		organics_get_file_url('js/colorpicker/colors.js'), array('jquery'), null, true );
			wp_enqueue_script('organics-colorpicker-script',	organics_get_file_url('js/colorpicker/jqColorPicker.js'), array('jquery'), null, true );
