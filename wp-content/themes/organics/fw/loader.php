...
if ( ! defined( 'ORGANICS_THEME_PATH' ) )	define( 'ORGANICS_THEME_PATH',	trailingslashit( get_template_directory() ) );
if ( ! defined( 'ORGANICS_FW_PATH' ) )		define( 'ORGANICS_FW_PATH',		ORGANICS_THEME_PATH . 'fw/' );
